...
const AddUser = () => {
  ...
  const handleClick = async (e) => {
     ...
     if(!val.firstName && !val.lastName && !val.username && !val.email && !val.city && !val.city && !val.password ){
    ...
    <div className="form-container ">
      <form className="form-signup">
        ...
        <input
          ...
          autoComplete="off" 
        />
        {validationError.firstName && <p style={{color:"red",fontSize:"13px"}}>{validationError.firstName}</p>}
        </div>
        <div className="col-lg-6">
        ...
        <input
          ...
          autoComplete="off" 
        />
        {validationError.lastName && <p style={{color:"red",fontSize:"13px"}}>{validationError.lastName}</p>}
        </div>
        </div>
        <div className="row">
        <div className="col-lg-6">
  ...
  <label className="custom-file-label" htmlFor="customFile">Image </label>
        ...
        {successMessage && <><div  style={{margin:"20px"}} className="alert alert-info sm-gap big-zindex"  >{successMessage} <Link to="/users" onClick={()=>{setError("");}}>Users</Link> </div></>}
        </div>
